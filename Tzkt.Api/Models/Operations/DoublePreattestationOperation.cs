...
{
    public class DoublePreattestationOperation : Operation
    {
        /// <summary>
        /// Type of the operation, `double_preattestation`
        /// </summary>
        public override string Type => ActivityTypes.DoublePreattestation;
        ...
        /// <summary>
        /// Height of the block from the genesis, at which double preattestation occurred 
        /// </summary>
        ...
        /// <summary>
        /// Information about the baker, accused for producing two different preattestations at the same level
        /// </summary>
