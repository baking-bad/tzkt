...
namespace Tzkt.Api.Controllers
{
    ...
    public class ContractsController : ControllerBase
    {
        ...
        public ContractsController(AccountRepository accounts, BigMapsRepository bigMaps, OutputCachingService outputCache)
        {
            Accounts = accounts;
            BigMaps = bigMaps;
            ...
            bool includeStorage = false)
        {
            ...
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value,("kind", kind), ("tzips", tzips), ("creator", creator),
                ("manager", manager), ("@delegate", @delegate), ("balance", balance), ("lastActivity", lastActivity), ("typeHash", typeHash),
                ("codeHash", codeHash), ("select", select), ("sort", sort), ("offset", offset), ("limit", limit), ("includeStorage", includeStorage));
        ...
        {
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value,("kind", kind));
        ...
        {            
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value);
            ...
            bool includeStorage = false)
        {
            ...
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value,("select", select), ("sort", sort), ("offset", offset), ("limit", limit), ("includeStorage", includeStorage));
        ...
        {
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value,("level", level), ("format", format));
        ...
        {
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value,("all", all), ("json", json), ("micheline", micheline), ("michelson", michelson));
        ...
        public async Task<ActionResult<Entrypoint>> GetEntrypointByName([Required][KTAddress] string address,
            ...
            bool michelson = false)
        {
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value, ("json", json), ("micheline", micheline), ("michelson", michelson));
        ...
        public async Task<ActionResult<ContractView>> GetContractViewByName([Required][KTAddress] string address, [Required] string name, bool json = true, bool micheline = false, bool michelson = false)
        {
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value, ("json", json), ("micheline", micheline), ("michelson", michelson));
        ...
        public async Task<ActionResult> BuildEntrypointParameters([Required][KTAddress] string address, [Required] string name, string value)
        {
            try
            {
                var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value, ("value", value));
        ...
        public async Task<ActionResult> BuildEntrypointParameters([Required][KTAddress] string address, [Required] string name, [FromBody] object value)
        {
            try
            {
                ...
                var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value, ("value", json));
        ...
        public async Task<ActionResult> GetStorage([Required][KTAddress] string address, [Min(0)] int level = 0, string path = null)
        {
            ...
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value, ("level", level), ("path", path));
        ...
        {
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value, ("level", level));
        ...
        {
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value, ("lastId", lastId), ("limit", limit));
            ...
            MichelineFormat micheline = MichelineFormat.Json)
        {
            ...
            var queryString = OutputCacheKeysProvider.BuildQuery(Request.Path.Value,("tags", tags), ("select", select), ("sort", sort), ("offset", offset), ("limit", limit), ("micheline", micheline));
            ...
            MichelineFormat micheline = MichelineFormat.Json)
        {
            ...
            var queryString = OutputCacheKeysProvider.BuildQuery($"/v1/bigmaps/{ptr}/keys",("active", active), ("key", key),
            ...
            MichelineFormat micheline = MichelineFormat.Json)
        {
            ...
            try
            {
                var queryString = OutputCacheKeysProvider.BuildQuery($"/v1/bigmaps/{ptr}/keys/{key}", ("micheline", micheline));
            ...
            MichelineFormat micheline = MichelineFormat.Json)
        {
            ...
            try
            {  
                var queryString = OutputCacheKeysProvider.BuildQuery($"/v1/bigmaps/{ptr}/keys/{key}/updates",("sort", sort), ("offset", offset), ("limit", limit), ("micheline", micheline));
            ...
            MichelineFormat micheline = MichelineFormat.Json)
        {
            ...
            var queryString = OutputCacheKeysProvider.BuildQuery($"/v1/bigmaps/{ptr}/historical_keys/{level}",("active", active), ("key", key),
            ...
            MichelineFormat micheline = MichelineFormat.Json)
        {
            ...
            try
            { 
                var queryString = OutputCacheKeysProvider.BuildQuery($"/v1/bigmaps/{ptr}/historical_keys/{level}/{key}",("level", level), ("key", key), ("micheline", micheline));
