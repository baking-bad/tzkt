...
namespace Tzkt.Api.Repositories
{
    public partial class OperationRepository : DbConnection
    {
        ...
        public async Task<IEnumerable<TxRollupFinalizeCommitmentOperation>> GetTxRollupFinalizeCommitmentOps(string hash, Symbols quote)
        {
            var sql = @"
                SELECT      o.*, b.""Hash""
                FROM        ""TxRollupFinalizeCommitmentOps"" as o
        ...
        public async Task<IEnumerable<TxRollupFinalizeCommitmentOperation>> GetTxRollupFinalizeCommitmentOps(string hash, int counter, Symbols quote)
        {
            var sql = @"
                SELECT      o.*, b.""Hash""
                FROM        ""TxRollupFinalizeCommitmentOps"" as o
        ...
        public async Task<IEnumerable<TxRollupFinalizeCommitmentOperation>> GetTxRollupFinalizeCommitmentOps(Block block, Symbols quote)
        {
            var sql = @"
                SELECT      o.*
                FROM        ""TxRollupFinalizeCommitmentOps"" as o
