            ...
            int limit)
        {
            var sql = new SqlBuilder($@"SELECT *, {AliasQuery} AS ""Alias"" FROM ""Accounts""")
                ...
                .Take(sort, offset, limit, x => x switch
                {
                    ...
                    "ownDelegatedBalance" => ("OwnDelegatedBalance", "OwnDelegatedBalance"),
                    "externalDelegatedBalance" => ("ExternalDelegatedBalance", "ExternalDelegatedBalance"),
                    "bakingPower" => ("BakingPower", "BakingPower"),
            ...
            string[] fields)
        {
            ...
            foreach (var field in fields)
            {
                switch (field)
                {
                    ...
                    #region [DEPRECATED]
                    case "stakingBalance": columns.Add(@"""VotingPower"""); break;
                    case "delegatedBalance": columns.Add(@"""ExternalDelegatedBalance"""); break;
