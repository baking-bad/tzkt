...
namespace Tzkt.Api.Repositories
{
    public partial class OperationRepository
    {
        ...
        public async Task<IEnumerable<Activity>> GetDoubleEndorsingOpsActivity(
            ...
            Symbols quote)
        {
            ...
            {
                if (account is not RawDelegate baker || baker.DoubleEndorsingCount == 0)
                    continue;
            ...
            return await GetDoubleEndorsings(
                or,
