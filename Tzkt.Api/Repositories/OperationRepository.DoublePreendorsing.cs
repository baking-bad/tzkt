...
namespace Tzkt.Api.Repositories
{
    public partial class OperationRepository
    {
        ...
        public async Task<IEnumerable<Activity>> GetDoublePreendorsingOpsActivity(
            ...
            Symbols quote)
        {
            ...
            {
                if (account is not RawDelegate baker || baker.DoublePreendorsingCount == 0)
                    continue;
            ...
            return await GetDoublePreendorsings(
                or,
