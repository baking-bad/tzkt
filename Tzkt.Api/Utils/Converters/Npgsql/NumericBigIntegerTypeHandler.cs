...
namespace Tzkt.Api
{
    public class NumericBigIntegerTypeHandler(PostgresType postgresType) : NpgsqlTypeHandler<BigInteger>(postgresType)
    {
        readonly NumericHandler Numeric = new(postgresType);
