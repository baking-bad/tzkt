    ...
    class Proto6Handler : ProtocolHandler
    {
        ...
        public override async Task InitProtocol(IBlock block)
        {
            ...
            if (protocol != null)
            {
                ...
                protocol.BlockReward0 = rawConst.BlockReward[0];
                protocol.BlockReward1 = rawConst.BlockReward[1];
                ...
                protocol.EndorsementReward0 = rawConst.EndorsementReward[0];
                protocol.EndorsementReward1 = rawConst.EndorsementReward[1];
        ...
        public override async Task InitProtocol()
        {
            ...
            currProtocol.BlockReward0 = rawConst.BlockReward[0];
            currProtocol.BlockReward1 = rawConst.BlockReward[1];
            ...
            currProtocol.EndorsementReward0 = rawConst.EndorsementReward[0];
            currProtocol.EndorsementReward1 = rawConst.EndorsementReward[1];
