...
namespace Tzkt.Sync.Protocols
{
    class Proto9Handler : ProtocolHandler
    {
        ...
        public Proto9Handler(TezosNode node, TzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto9Handler> logger)
