...
namespace Tzkt.Sync.Protocols
{
    class Proto3Handler : ProtocolHandler
    {
        ...
        public Proto3Handler(TezosNode node, TzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto3Handler> logger)
