...
namespace Tzkt.Sync.Protocols
{
    class Proto10Handler : ProtocolHandler
    {
        ...
        public Proto10Handler(TezosNode node, TzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto10Handler> logger)
