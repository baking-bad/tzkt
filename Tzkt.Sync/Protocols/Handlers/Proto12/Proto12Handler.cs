...
namespace Tzkt.Sync.Protocols
{
    class Proto12Handler : ProtocolHandler
    {
        ...
        public Proto12Handler(TezosNode node, TzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto12Handler> logger)
