...
namespace Tzkt.Sync.Protocols
{
    class Proto2Handler : ProtocolHandler
    {
        ...
        public Proto2Handler(TezosNode node, TzktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto2Handler> logger)
