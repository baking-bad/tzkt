...
using Mvkt.Sync.Protocols.Proto14;
...
namespace Mvkt.Sync.Protocols
{
    class Proto14Handler : ProtocolHandler
    {
        ...
        public Proto14Handler(MavrykNode node, MvktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto14Handler> logger, IMetrics metrics)
