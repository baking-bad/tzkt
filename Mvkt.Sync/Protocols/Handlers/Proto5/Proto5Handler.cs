...
using Mvkt.Sync.Protocols.Proto5;
...
namespace Mvkt.Sync.Protocols
{
    class Proto5Handler : ProtocolHandler
    {
        ...
        public Proto5Handler(MavrykNode node, MvktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto5Handler> logger, IMetrics metrics)
