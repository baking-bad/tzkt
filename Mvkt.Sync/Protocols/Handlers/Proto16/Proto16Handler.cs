...
using Mvkt.Sync.Protocols.Proto16;
...
namespace Mvkt.Sync.Protocols
{
    class Proto16Handler : ProtocolHandler
    {
        ...
        public Proto16Handler(MavrykNode node, MvktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto16Handler> logger, IMetrics metrics)
