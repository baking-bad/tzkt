...
using Mvkt.Sync.Protocols.Proto1;
...
namespace Mvkt.Sync.Protocols
{
    class Proto1Handler : ProtocolHandler
    {
        ...
        public Proto1Handler(MavrykNode node, MvktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto1Handler> logger, IMetrics metrics)
