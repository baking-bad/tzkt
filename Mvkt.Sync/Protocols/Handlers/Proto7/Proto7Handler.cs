...
using Mvkt.Sync.Protocols.Proto7;
...
namespace Mvkt.Sync.Protocols
{
    class Proto7Handler : ProtocolHandler
    {
        ...
        public Proto7Handler(MavrykNode node, MvktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto7Handler> logger, IMetrics metrics)
