...
using Mvkt.Sync.Protocols.Proto15;
...
namespace Mvkt.Sync.Protocols
{
    class Proto15Handler : ProtocolHandler
    {
        ...
        public Proto15Handler(MavrykNode node, MvktContext db, CacheService cache, QuotesService quotes, IServiceProvider services, IConfiguration config, ILogger<Proto15Handler> logger, IMetrics metrics)
