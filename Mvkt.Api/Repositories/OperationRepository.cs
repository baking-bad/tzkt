...
namespace Mvkt.Api.Repositories
{
    public partial class OperationRepository
    {
        ...
        public async Task<bool?> GetStatus(string hash)
        {
            ...
            return await GetStatus(db, nameof(MvktContext.TransactionOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.OriginationOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.DelegationOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.RevealOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.RegisterConstantOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.SetDepositsLimitOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.IncreasePaidStorageOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.UpdateConsensusKeyOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.TransferTicketOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.SmartRollupAddMessagesOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.SmartRollupCementOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.SmartRollupExecuteOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.SmartRollupOriginateOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.SmartRollupPublishOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.SmartRollupRecoverBondOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.SmartRollupRefuteOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.StakingOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.SetDelegateParametersOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.DalPublishCommitmentOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.TxRollupCommitOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.TxRollupDispatchTicketsOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.TxRollupFinalizeCommitmentOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.TxRollupOriginationOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.TxRollupRejectionOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.TxRollupRemoveCommitmentOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.TxRollupReturnBondOps), hash)
                ?? await GetStatus(db, nameof(MvktContext.TxRollupSubmitBatchOps), hash);
        }
