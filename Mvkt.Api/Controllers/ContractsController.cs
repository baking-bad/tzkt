...
namespace Mvkt.Api.Controllers
{
    ...
    public class ContractsController : ControllerBase
    {
        ...
        /// <param name="legacy">If `true` (by default), the `metadata` field will contain mvkt profile info, or TZIP-16 metadata otherwise. This is a part of a deprecation mechanism, allowing to switch to new functionality smoothly.</param>
        /// <returns></returns>
        [HttpGet("{address}")]
        ...
        /// Even if the key is complex (an object or an array), you can specify it as is, for example, `/keys/{"address":"mv123","nat":"123"}`.</param>
        /// <param name="micheline">Format of the bigmap key and value: `0` - JSON, `1` - JSON string, `2` - Micheline, `3` - Micheline string</param>
        /// <returns></returns>
