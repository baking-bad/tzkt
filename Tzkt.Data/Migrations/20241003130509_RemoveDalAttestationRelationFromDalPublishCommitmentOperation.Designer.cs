...
namespace Tzkt.Data.Migrations
{
    ...
    [Migration("20241003130509_RemoveDalAttestationRelationFromDalPublishCommitmentOperation")]
    partial class RemoveDalAttestationRelationFromDalPublishCommitmentOperation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tzkt.Data.Models.Protocol", b =>
                {
                    ...
                    b.Property<int>("DalAttestationLag")
                        .HasColumnType("integer");

                    b.Property<int>("DalAttestationThreshold")
                        .HasColumnType("integer");

                    b.Property<int>("DalShardsPerSlot")
                        .HasColumnType("integer");

                    b.Property<int>("DalSlotsPerLevel")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Tzkt.Data.Models.DalPublishCommitmentOperation", b =>
                {
                    b.HasOne("Tzkt.Data.Models.Block", "Block")
                        .WithMany("DalPublishCommitmentOps")
                        .HasForeignKey("Level")
                        .HasPrincipalKey("Level")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tzkt.Data.Models.SetDelegateParametersOperation", b =>
                {
                    b.HasOne("Tzkt.Data.Models.Block", "Block")
                        .WithMany("SetDelegateParametersOps")
                        .HasForeignKey("Level")
                        .HasPrincipalKey("Level")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tzkt.Data.Models.Block", b =>
                {
                    ...
                    b.Navigation("SetDelegateParametersOps");
